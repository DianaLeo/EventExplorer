const EVENTS = [
    ...
    {
        id: 'Kids-Face-Painting',
        publisher: {
          avatar: 'https://picsum.photos/seed/OluArtStudio/160/160',
          displayName: 'Olu Art Studio',
        },
        title: 'Urban Greeting Workshop',
        tagline: 'Immersive experience of how the artists build up one exhibition',
        createdAt: '4d ago',
        description: 'Do you have a dream of becoming an artist? Here is a once-in-a-lifetime opportunity! The team led by Mr. Eduard Franz decided to launch an exhibition that "engaged the entire city in creation". The exhibition consisted of facades and structures made of cardboard, and participants could',
        images: [
          { id: 'i1', src: 'https://picsum.photos/seed/FacePainting1/1920/1080', alt: 'Kids-Face-Painting' },
          { id: 'i2', src: 'https://picsum.photos/seed/FacePainting2/1920/1080', alt: 'Kids-Face-Painting' },
          { id: 'i3', src: 'https://picsum.photos/seed/FacePainting3/1920/1080', alt: 'Kids-Face-Painting' },
          { id: 'i4', src: 'https://picsum.photos/seed/FacePainting4/1920/1080', alt: 'Kids-Face-Painting' },
          { id: 'i5', src: 'https://picsum.photos/seed/FacePainting5/1920/1080', alt: 'Kids-Face-Painting' },
        ],
        followers: [
          { id: 'f1', src: 'https://picsum.photos/seed/Silver/100', alt: 'avatar' },
          { id: 'f2', src: 'https://picsum.photos/seed/Ivy/100', alt: 'avatar' },
